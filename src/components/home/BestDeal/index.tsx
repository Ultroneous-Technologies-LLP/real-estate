  ...
  return (
    ...
    >
      <div className="relative flex flex-col xl:flex-row items-center justify-center">
        <h2
          className="text-2xl/9 md:text-32/12 xl:text-5xl/12 font-lufga-preload text-police-blue text-center"
          id="best-deals-title"
        >
          <span>{title}</span>
        </h2>
      ...
      <p className="text-xs/4.5 md:text-sm/5 xl:text-2xl/6.5 font-lufga-preload text-cadet-blue-crayola max-w-75.5 xl:max-w-124.5 mx-auto w-full pt-1 xl:pt-4 text-center">
        {description}
      </p>
